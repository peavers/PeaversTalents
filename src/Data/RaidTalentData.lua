	...
	[5] = {  -- Priest
		specs = {
			[256] = {
				...
				["ansurek"] = {
					label = "Ansurek",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAAA2mtZGD2GjZmxMbmtZmZmhBAAAAAAAAAAAzilZbYbmZwswwgxws4B2mpxELDYmBACwsNLbgxmN",
				},
				["broodtwister-ovinax"] = {
					label = "Broodtwister Ovi'nax",
				...
				["kyveza"] = {
					label = "Ky'veza",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAADw2sNz4BmZ2GjZGmZzsNzMzMAAAAAAAAAAAAzilZbYbmZwswwgxwsw2MNmYZAzMAQAmtZZDM2sB",
				},
				["rashanan"] = {
					label = "Rasha'nan",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAAA2mtZGD2GjZmxMbmlZmZmhBAAAAAAAAAAAzilZbYbmZwswwMzMGsw2MNmYBYmBACwsNLbgxmN",
	...
	[6] = {  -- Death Knight
		specs = {
			[250] = {
				...
				["kyveza"] = {
					label = "Ky'veza",
					talentString = "CoPAAAAAAAAAAAAAAAAAAAAAAghBzMjZMzYsMjZmZaGGzMDjBAAAAAzMzMzMzMzmZmxAAAgZmZmBAAAYgBmxoxyGgtBsBwMYD",
				},
				["rashanan"] = {
					label = "Rasha'nan",
					talentString = "CoPAAAAAAAAAAAAAAAAAAAAAAghBzYMjZGjlZMzMTzMGmZMjBAAAAAzMzMzMzMzmZmxAAAgZmZmBAAAYgBmxoxyGgtBsBwMYD",
